 ...
 * @since jdk1.8
 */
public class TestGenerateed {

    private static final Logger logger = LoggerFactory.getLogger(SqlGenerator.class);

    public static void main(String[] args) {
        //实体类所在的package在磁盘上的绝对路径
        String packageName = "D:\\JavaProject\\fballfans\\fballfans-server\\src\\main\\java\\com\\john\\server\\domain\\entity";
        //生成sql的文件夹
        String filePath = "D:\\JavaProject\\fballfans\\fballfans-server\\src\\main\\java\\com\\john\\server\\domain\\entity";
        //项目中实体类的路径
        String prefix = "com.john.server.domain.quote.";
        String className = "";
